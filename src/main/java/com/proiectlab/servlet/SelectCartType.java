 ...
 * @author frati
 */
@WebServlet(name = "SelectCartType", urlPatterns = {"/SelectCartType"})
public class SelectCartType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("type") != null) {
            String cartType = request.getParameter("type").toUpperCase();

            Cart.getInstance().setCartType(CartType.valueOf(cartType));
        }
